...
/**
 * The function calculates the Bhattacharyya distance between two probability distributions
 ...
 * 
 * @return The function `bhattacharyya_distance` is returning the Bhattacharyya distance between two
 * probability density functions represented by the input function pointers `x` and `y`.
 */
double bhattacharyya_distance(double (*x)(double), double (*y)(double)) {
    double res = 0.0;
    double z, f, g, cm, tmp;
...
int main () {
    printf("Bhattacharyya-dist unif-vs-unif = %f\n", bhattacharyya_distance(dunif, dunif));
    printf("Bhattacharyya-dist quad-vs-quad = %f\n", bhattacharyya_distance(dquad, dquad));
    printf("Bhattacharyya-dist unif-vs-quad = %f\n", bhattacharyya_distance(dunif, dquad));
    printf("Bhattacharyya-dist quad-vs-unif = %f\n", bhattacharyya_distance(dquad, dunif));
    return 0;
}
